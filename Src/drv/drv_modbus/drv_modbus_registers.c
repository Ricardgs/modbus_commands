...
const uint16_t vdrv_modbus_0_input_regs_addr[DRV_MODBUS_0_INPUT_REG_MAX] =
{
		...
		0x0001,	// DRV_MODBUS_0_INPUT_REG_ACTUAL_CLK_FREQ_HIGH
		0x0002	// DRV_MODBUS_0_INPUT_REG_ACTUAL_CLK_FREQ_LOW
};

const uint16_t vdrv_modbus_0_holding_regs_addr[DRV_MODBUS_0_HOLDING_REG_MAX] =
{
		0x0000,	// DRV_MODBUS_0_HOLDING_REG_REQUESTED_CLK_FREQ_HIGH
		0x0001,	// DRV_MODBUS_0_HOLDING_REG_REQUESTED_CLK_FREQ_LOW
